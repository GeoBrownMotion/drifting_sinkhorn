...
class MAEEncoder(BaseEncoder):
    def __init__(
        ...
        # load pretrained mae
        self.mae = self.load_mae().eval()

        # wrap with feature extractor
        self.mae = FeatureExtractor(self.mae, layers=layers)

    @staticmethod
    def load_mae() -> nn.Module:
        ...
        interpolate_pos_embed(mae, state_dict)
        msg = mae.load_state_dict(state_dict, strict=False)
...
# ======================================================================================
# The following code is copied from https://github.com/facebookresearch/mae
# ======================================================================================
