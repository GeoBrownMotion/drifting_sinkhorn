...
class ConvNeXtv2Encoder(BaseEncoder):
    def __init__(
            self,
            layers: list[str] = ("stages.0", "stages.1", "stages.2", "stages.3"),
        ...
        self.convnextv2 = self.load_convnextv2().eval()

        # wrap with feature extractor
        self.convnextv2 = FeatureExtractor(self.convnextv2, layers=layers)

    @staticmethod
    def load_convnextv2() -> nn.Module:
        ...
        convnextv2.load_state_dict(state_dict)
        return convnextv2
    ...
    def forward(self, x: Tensor, *args, **kwargs) -> Tensor:
        ...
        # extract features
        z = self.preprocess(x)
        features = self.convnextv2(z)
        # postprocess features
        for k, v in features.items():
            results.update({f"convnextv2-{k}": postprocess(
                v.permute(0, 2, 3, 1),
...
# ======================================================================================
# The following code is copied from https://github.com/facebookresearch/ConvNeXt-V2
# ======================================================================================
